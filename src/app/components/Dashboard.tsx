...
const Dashboard = () => {
    return (
        <div className="bg-back2 w-full h-full border-t-1 border-line flex flex-col py-[1%] px-[4%]">
            ...
            <div className="w-full h-[17%] mb-[2%] flex flex-row p-1 gap-[2%]">
                <Card title='Add Filament' desc='Add new filament to inventory.'/>
                <Card title="Log Print" desc='Generate a Print Report'/>
