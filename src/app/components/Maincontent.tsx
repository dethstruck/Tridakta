...
const Maincontent = () => (
  <div className="px-4 mt-24 lg:mt-4 2xl:mt-16 flex flex-col items-center text-center max-w-screen-xl mx-auto flex-grow">
    ...
    <div className="flex flex-col sm:flex-row gap-4 mt-8">
      <Link href="/dashboard" className="bg-white text-black font-bold py-2 px-4 rounded-lg flex items-center justify-center hover:bg-white/90 transition-all duration-200">
      Launch Dashboard
